...
1. We get the loan period from **Library Management Settings** by using `dataent.db.get_value`.
1. We run a query in the database with `dataent.db.sql`
1. Email is sent via `dataent.sendmail`
