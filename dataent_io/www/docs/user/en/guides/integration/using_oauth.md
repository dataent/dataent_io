...
URL:
```
[GET] 0.0.0.0:8000/api/method/dataent.integrations.oauth2.authorize
```
Params:
```
...
URL:
```
[POST] 0.0.0.0:8000/api/method/dataent.integrations.oauth2.get_token
```
Params:
```
...
URL:
```
[POST] 0.0.0.0:8000/api/method/dataent.integrations.oauth2.revoke_token
```
Params:
```
