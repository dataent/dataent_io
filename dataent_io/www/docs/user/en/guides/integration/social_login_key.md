...
Add social login providers like Facebook, Dataent, Github, Google, Microsoft, etc and enable social login.
...
- **Social Login Provider** : `Dataent`
- **Client ID** : `ABCDEFG`
- **Client Secret** : `123456`
- **Enable Social Login** : `Check`
- **Base URL** : `https://epaas.org` (required for some providers)
