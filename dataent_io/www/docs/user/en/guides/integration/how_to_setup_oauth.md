...
<a href="https://tools.ietf.org/html/rfc6749">OAuth 2.0</a> provider based on <a href="https://github.com/idan/oauthlib">oauthlib</a> is built into dataent. Third party apps can now access resources of users based on Frappé Role and User permission system. To setup an app to access
