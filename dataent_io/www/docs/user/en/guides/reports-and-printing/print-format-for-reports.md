...
To create a new Print Format, just drop in a `.html` file in the folder of the query report. For example, for the [General Ledger](https://github.com/dataent/epaas/tree/develop/epaas/accounts/report/general_ledger) report in EPAAS, you can drop in a file called `general_ledger.html` along side the `.js` and `.py` files.

##### Tree Of `epaas/accounts/general_ledger`
...
[General Ledger Print Format Template](https://github.com/dataent/epaas/blob/develop/epaas/accounts/report/general_ledger/general_ledger.html)
