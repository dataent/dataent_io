...
1. Go to Settings > Advanced, find the field **Valid OAuth redirect URIs**, and enter:    
    **http://{{ yoursite }}/api/method/dataent.www.login.login\_via\_facebook**
...
1. Fill the form with:
	...
	- Authorized redirect URI as  
	    **http://{{ yoursite }}/api/method/dataent.www.login.login\_via\_google**
...
1. Fill the form with:
	...
	- Authorization callback URL as  
	    **http://{{ yoursite }}/api/method/dataent.www.login.login\_via\_github**
...
1. Fill the form with:
	...
	- Single Sign-on URL as
	    **http://{{ yoursite }}/api/method/dataent.www.login.login\_via\_office365**
