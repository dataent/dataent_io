...
1. Add it to `build.json` for your app (you can include it in `dataent.min.js` or your own javascript file).
1. To render it in your app, use `dataent.render(dataent.templates.address_list, {[context]})`

#### Example Template:

From `epaas/public/js/templates/address_list.js`
