...
You can add filters to the query:
	...
	dataent.ui.form.on("Bank Reconciliation", "onload", function(frm) {
...
**Example:**
	...
	def lead_query(doctype, txt, searchfield, start, page_len, filters):
		return dataent.db.sql("""select name, lead_name, company_name from `tabLead`
			where docstatus &lt; 2
...
[https://github.com/dataent/epaas/blob/develop/epaas/controllers/queries.py](https://github.com/dataent/epaas/blob/develop/epaas/controllers/queries.py)
