...
This involves typically [pushing fixes](https://github.com/dataent/epaas/issues) to the products, [adding new features](https://github.com/dataent/epaas/issues?labels=feature+request&page=1&state=open), optimizing current ones, [writing tests](https://travis-ci.org/dataent/epaas), refactoring the code, helping deployment, [helping customers](https://discuss.epaas.com), building administration and automation tools for testing and production.
...
The job of an ERP Specialist is to help our customers use EPAAS to the best of their abilities. Implementing ERP systems is a huge investment for any organization and we make sure that they have great support from our end in helping them make a smooth transition to EPAAS.
