...
export const demoSections = [
  ...
  &lt;figure id="frost-chart"&gt;&lt;/figure&gt;`,
            },
            {
                ...
                lang: "javascript",
                content: `  // Javascript
  let chart = new dataent.Chart( "#frost-chart", { // or DOM element
    data: {
...

	{
        ...
        contentBlocks: [
            ...
            },
            {
                type: "code",
                lang: "javascript",
                content: `  let heatmap = new dataent.Chart("#heatmap", {
    type: 'heatmap',
    title: "Monthly Distribution",
    data: {
        ...
        contentBlocks: [
            {
                ...
                html: `<p data-height="299" data-theme-id="light" data-slug-hash="wjKBoq" data-default-tab="js,result"
                    data-user="pratu16x7" data-embed-version="2" data-pen-title="Dataent Charts Demo" class="codepen">
                    See the Pen <a href="https://codepen.io/pratu16x7/pen/wjKBoq/">Dataent Charts Demo</a>
  ...
  `
...

    {
        ...
        contentBlocks: [
            ...
            { type: "code", lang: "console", content: `  npm install dataent-charts` },

            { type: "text", content: 'And include it in your project' },
            { type: "code", lang: "javascript", content: `  import { Chart } from "dataent-charts` },
  ...
  new dataent.Chart();   // Browser`,
            ...
            { type: "text", content: '... or include it directly in your HTML' },
            {
                type: "code",
                lang: "html",
                content: `  &lt;script src="https://unpkg.com/dataent-charts@1.1.0"&gt;&lt;/script&gt;`,
            },
        ]
    }
]
